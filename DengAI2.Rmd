...
algorithmList <- c("earth", "xgbDART", "knn")
...
models <- caretList(total_cases ~ ., 
                    ...
                    tuneList=list(
                      rf=caretModelSpec(method="rf", tuneGrid=grid_rf),svmLinear=caretModelSpec(method="svmLinear", tuneGrid=grid_svmLinear),                      svmRadial=caretModelSpec(method="svmRadial", tuneGrid=grid_svmRadial)))
...
predict_svmLinear <- predict(models$svmLinear, testData4)
...
methods <- c("mlp", "earth", "rf", "xgbDART", "svmRadial", "knn", "svmLinear")
...
performetrics[7,2] <- rmse.sj.svmLinear
...
performetrics[7,3] <- mae.sj.svmLinear
